...
export default function InteractiveAvatar() {
  ...
  async function startSession() {
    ...
    /*avatar.current.on(StreamingEvents.AVATAR_TALKING_MESSAGE, (e) => {
      ...
      if (message.includes("abrir explorador")) {
          open('https://www.google.com')  // Abre una nueva ventana del navegador en Google
      }
    ...
    avatar.current?.on(StreamingEvents.USER_END_MESSAGE, (e) => {
      console.log(">>>>> User end message:", e);
      const message = String(e);
      console.log(e);
      console.log(message);
    ...
    avatar.current?.on(StreamingEvents.USER_TALKING_MESSAGE, (message) => {
      ...
      if (message.detail.message.includes("abrir explorador")) {
          open('https://www.google.com')  // Abre una nueva ventana del navegador en Google
      }
